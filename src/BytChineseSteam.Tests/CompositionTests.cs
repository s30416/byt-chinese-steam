...
namespace BytChineseSteam.Tests
{
    public class CompositionTests
    {
        ...
        public void CreateKey_ShouldAutomaticallyAddToGame()
        {
            ...
            var key = new Key(game, admin, "123-ABC", 59.99m, DateTime.Now, 0, new List<string> { "Base Game" });
        ...
        public void DeleteGame_ShouldCascadeDeleteKeys()
        {
            ...
            var key2 = new Key(game, admin, "KEY-2", 20, DateTime.Now, 0, new List<string>{"B"});
